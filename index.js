...
app.post('/login', (req, res) => {
    if (req.body.user === 'natan' && req.body.pass === '123456') {
        const id = 1;
...
/* D. Rota POST para cadastrar um novo aluno */
...
/* E. Rota PUT a para atualizar um aluno */
...
/* F. Rota DELETE para excluir um aluno */
